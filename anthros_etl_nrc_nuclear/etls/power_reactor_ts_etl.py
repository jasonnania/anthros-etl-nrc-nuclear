...
NRC_NUCLEAR_REACTOR_STATUS_ENERGYTOOLS_DF_TO_TSDB_DF = Pipeline([NRCNuclearReactorTransformer(),
                                                           TSDBSetMetaIdsTransformer()])


NRC_NUCLEAR_REACTOR_STATUS_TO_TSDB_DF = NRC_NUCLEAR_REACTOR_STATUS_TO_ENERGYTOOLS_DF_ETL + NRC_NUCLEAR_REACTOR_STATUS_ENERGYTOOLS_DF_TO_TSDB_DF #+ [TimeSeriesSpotTableLoader(process_name = 'NYISO_MARKET_LBMP')]

if __name__ == '__main__': 
    import sys
    logging.basicConfig(stream=sys.stdout, level=logging.INFO)
    etl_pl = NRC_NUCLEAR_REACTOR_STATUS_TO_TSDB_DF
